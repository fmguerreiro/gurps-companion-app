...
(def spells [{:name :air-jet, :prerequisites [:shape-air], :college :air, :ref "Magic p. 24"}
             ...
             {:name :flameturning, :prerequisites [#{:resist-fire [:apportation :shape-fire]}], :college :fire, :ref "Classic: Grimoire p. 30"}
...
(def spells-by-college
  {:fire #{:flameturning :warmth :resist-fire :high-explosive-fireball :seek-fire :detonate :flaming-missiles :hellfire-rain :snuff-life's-flame :cremate :rain-of-fire :summon-fire-elemental :puff :explosive-fireball :summon-lava-lizard :towering-inferno :hellfire-orb :oven-mitts :slow-fire :fire-swarm :deflect-energy :balor's-eye-fire :explosive-hellfire-orb :fire-cloud :phantom-flame :shape-fire :shaped-charge-fireball :hellfire-breath :improved-explosive-fireball :ember :control-lava-lizard :blast-ball :fireproof :great-deflect-energy :ignite-fire :flaming-armor :create-fire-elemental :heat :resist-cold :hellfire-jet :cold :control-fire-elemental :create-fire :burning-death :smoke :fireball :self-destruct :mass-detonate :essential-flame :body-of-flames :flame-jet :fast-fire :flaming-weapon :extinguish-fire :burning-touch :breathe-fire :mass-resist-fire}
   ...
   :movement #{:quarter :swim :steady-hand :cushion :transfer-pregnancy :cloud-walking :blink :lockmaster :homing-missile :manipulate :blink-other :ley-float :reorient :great-haste :magic-bullet :beacon :glue :hinder :flying-carpet :grease :rapid-journey :open-door :reduce-recoil :locksmith :levitation :freedom :dancing-object :ley-running :air-vortex :ethereal-body :remove-fetus :distant-blow :slasher :hawk-flight :trace-teleport :haste :divert-teleport :great-deflect-missile :increase-burden :light-tread :disruption :cloud-vaulting :undo :hail-of-lead :slow :poltergeist :slide :wizard-hand :force-ball :ley-vehicle :deflect-missile :winged-knife :teleport :flee :flight :apportation :quick-march :pull :collision :hold-fast :repel :slow-fall :jump :teleport-other :sink :crushing-fist :lighten-burden :long-march :wallwalker}
   :sound #{:volume-control :sound :wizard-ear :delayed-message :far-hearing :silver-tongue :resist-sound :invisible-wizard-ear :fatal-frequency :imitate-voice :converse :call :improved-concussion :thunderclap :silence :echoes-of-the-past :alter-voice :noise :perilous-pulsations :mer-speech :selective-hearing :scribe :squeak :sound-jet :hush :sound-vision :throw-voice :wail-of-the-banshee :great-voice :concussion :withering-wail :mage-stealth :ley-speech :wizard-mouth :wall-of-silence :garble :musical-scribe :keen-hearing :voices :message :disrupt}
   :knowledge #{:small-vision :astral-vision :alarm :wizard-ear :far-hearing :tell-time :far-feeling :detect-magic :know-recipe :identify-spell :analyze-magic :remember-path :seek-magic :trace :echoes-of-the-past :seek-ley-line :seek-navy :memorize :history :tell-position :retro-reading :sweet-oblivion :thaumatomancy :summon-shade :know-location :ancient-history :recall :earth-vision :know-thyself :plastic-vision :aura :mage-sight :test-load :measurement :divination :invisible-wizard-eye :pathfinder :wizard-eye :far-tasting :images-of-the-past :sense-mana :vision-of-doom :glass-wall :prehistory :wizard-hand :analyze-heredity :seeker :televisomancy :air-vision :necrovision :forbidden-wisdom :mage-sense :scents-of-the-past :seek-number :know-true-shape :wizard-nose :wizard-mouth :water-vision :see-secrets :keyfinder :schematic :mind-over-matter :find-direction :reconstruct-spell :test :metal-vision :projection :plant-vision :identify-loot}
   :meta #{:spellguard :suspend-magery :counterspell :hang-spell :restore-mana :ward :remove-curse :dispel-magic :scryguard :scryfool :end-scene :curse :catch-spell :raise-cone-of-power :seek-magic :mana-storm :ley-line-creation :suspend-curse :great-ward :scrywall :telecast :false-aura :penetrating-spell :drain-magery :thaumatomancy :bless :ley-supply :sovereign-countermagic :preemptive-experience :suspend-mana :conceal-magic :pentagram :suspend-magic :magic-resistance :dispel-spark :maintain-spell :use-item :throw-spell :lend-spell :dread-curse :self-destruct :spell-wall :displace-spell :charge-powerstone :spell-shield :drain-mana :ley-buffer :void-bolt :suspend-spell :sovereign-ward :mana-vortex :punishment-circle :internalize-elixir :reflect :remove-aura :steal-spell}
   :air #{:shape-air :lightning-whip :predict-weather :phlogiston-discharge :destroy-air :chain-lightning :jolt :cool :spark-cloud :electric-missiles :earth-to-air :explosive-lightning :improved-concussion :storm-shelter :phlogiston-arc :safe-boarding :breathe-air :steal-breath :spark-storm :summon-air-elemental :cloud :lightning :cloud-of-doom :air-vortex :storm :resist-lightning :body-of-wind :stinkguard :walk-on-air :falling-sky :purify-signal :windstorm :air-jet :wind :essential-air :atmosphere-dome :snow :electric-armor :warm :twisting-terror :odor :shocking-touch :body-of-air :mighty-breath :phlogiston-detonation :embolism :seek-emitter :stroke-of-lightning :devitalize-air :improved-explosive-lightning :diver's-blessing :wall-of-lightning :air-vision :create-air :concussion :stench :lightning-stare :phlogiston-touch :lightning-missiles :phlogiston-sphere :electric-weapon :sandstorm :clouds :seek-air :control-air-elemental :no-smell :lightning-armor :static-charge :wall-of-wind :mass-resist-lightning :purify-air :phlogiston-stare :ball-of-lightning :rain :breathe-water :lightning-weapon :body-of-lightning :create-air-elemental}
   :enchantment #{:curse-virus :great-wish :magician's-minion :soul-golem :resilient-golem :simulacrum :impart-skill :suspend-enchantment :lesser-wish :emergency-staff :speed :doppelganger :spellgraft :adjustable-clothing :golem :mortal-malefice :compulsive-reader :ley-line-creation :wish :ensorcel :amulet :spellbook-enchantment :spellprocessor :talisman :dwarfish-reinforcement :temporary-enchantment :power :mana-warhead :hex :costume :doom-wish :scroll :remove-enchantment :enchant :leak :electric-power :impression-blocker :narrative-conveyance :spell-stone :sorcerer's-stand-in :hideaway :create-chimera :live-libram :resist-enchantment :vengeful-staff :malefice}
   :healing #{:cure-addiction :cure-insanity :suspended-animation :stop-spasm :transfer-pregnancy :aide :recover-energy :remove-contagion :cleansing :awaken :mass-resist-poison :major-healing :relieve-paralysis :relieve-madness :halt-aging :cure-disease :cure-starvation :remove-fetus :resuscitate :resist-poison :restore-speech :restore-hearing :restoration :relieve-sickness :final-rest :restore-memory :euthanize :resist-disease :lend-energy :stop-bleeding :sense-disease :transference-bolt :share-energy :cure-dehydration :mass-resist-disease :cure-radiation :minor-healing :youth :instant-regeneration :share-vitality :regeneration :relieve-addiction :neutralize-poison :detect-poison :aid :great-healing :bender-defender :sea-legs :birth-control :ease-labor :lend-vitality :archmagi's-recuperation :healing-slumber :instant-neutralize-poison :instant-restoration :test :resurrection :analgesic :stop-paralysis :disinfect :body-reading :restore-sight}
   :light-and-darkness #{:small-vision :mass-invisibility :cleansing-light :mage-light :gloom :continual-mage-light :twinkle :wall-of-light :coherent-light-jet :infrared-flash :bright-vision :continual-sunlight :flash :colors :remove-shadow :disruption-bolt :hide :mass-shade :invisible-sunbolt :images-of-the-past :shadow-slay :blur :remove-reflection :invisibility :continual-light :infravision :night-vision :shape-light :shape-darkness :light-jet :sunburst :phosphorescence :see-invisible :mirror :light :darkness :shadowplay :glow :sunbolt :body-of-shadow :shade :blackout :goggles :sunlight :dark-vision :hawk-vision}
   :communication-and-empathy #{:exchange-bodies :mind-sending :broadcast-spell :telepathic-overload :persuasion :presence :switch-bodies :hide-emotion :gift-of-tongues :dream-viewing :control-person :hide-thoughts :possession :sorcerous-signal :gift-of-letters :dispel-possession :compel-lie :delete-commercia :sense-emotion :mer-speech :truthsayer :drama :retrogression :dream-projection :borrow-skill :speed-data :compel-truth :borrow-number :permanent-possession :identify-caller :bedtime-reading :communication :lend-language :ack :telepathy :dream-sending :vexation :accursed-triangle :mind-reading :insignificance :seek-number :magic-switchboard :delete-commercials :lend-skill :illuminated-writing :sense-life :absorb-book :wrong-number :soul-rider :sense-foes :machine-speech :compel-written-truth :mind-whip :message :borrow-language :mind-search}
   :earth #{:stone-to-earth :essential-earth :control-earth-elemental :volcano :alter-terrain :partial-petrification :sand-blast :move-terrain :rain-of-stones :purify-earth :earth-to-air :boulder-barrage :predict-earth-movement :orichalcum-missiles :badger-paws :summon-lava-lizard :seek-earth :seek-pass :sand-jet :entombment :shape-stone :shape-earth :walk-through-earth :earth-vision :control-lava-lizard :dust-to-dust :stone-missile :seismic-shock :flesh-to-stone :body-of-stone :flesh-to-adamant :pebble :summon-earth-elemental :adamant-hail :earthquake :sandstorm :heart-of-stone :orichalcum-edge :create-earth-elemental :earth-to-water :mud-jet :stone-to-flesh :gargoyle-skin :create-earth :steelwraith :earth-to-stone :adamant-missile :spotless-hands}
   :gate #{:phase-other :hide-object :blink :hell-zone :blink-other :timeslip-other :timeport :reorient :beacon :rapid-journey :accelerate-time :seek-gate :create-door :suspend-time :easy-rider :phase :plane-shift :time-out :trace-teleport :create-gate :underworld-imprisonment :divert-teleport :slow-time :splat :timeslip :planar-summons :null-sphere :scry-gate :invoke :timeport-other :teleport :teleport-shield :plane-shift-other :planar-visit :sanctuary :control-gate :teleport-other :dimensional-dissection}
   :animal #{:repel-animal :great-shapeshift :repel-hybrids :protect-animal :shapeshift-others :beast-summoning :spider-silk :call :hybrid-control :beast-speech :thousand-legged-demise :merging-shapeshifting :groom :permanent-shapeshifting :abominable-alteration :partial-shapeshifting :beast-rouser :rider-within :beast-seeker :beast-soother :creeping-plague :animal-control :beast-possession :permanent-beast-possession :master :rider :beast-link :shapeshifting :insect-repellent}
   :making-and-breaking #{:weaken :awaken-craft-spirit :copy :shatterproof :knot :stiffen :self-repairing :mapmaker :transform-object :soilproof :minefield :dye :ruin :fasten :restore :inspired-creation :shatter :soul-creation :rejoin :inscribe :tack :repair :animate-object :mystic-mark :wizardly-workshop :draw-together-shards :sharpen :annihilation :rive :enlarge-object :shrink-object :weapon-self :rebuild :explosive-mine :contract-object :destabilization :reshape :transfigure-object :disintegrate :explode :immediate-action :find-weakness :toughen :transparency :clean :extend-object}
   :protection-and-warning #{:utter-wall :warmth :protect-animal :sense-danger :resist-sound :mystic-mist :nightingale :reverse-missiles :prismatic-mist-area :missile-shield :storm-shelter :shield :mass-resist-poison :turn-blade :resist-lightning :stinkguard :oven-mitts :resist-radiation :selective-hearing :resist-poison :return-missile :umbrella :reflect-gaze :mass-shade :utter-dome :resist-disease :sense-observation :resist-water :watchdog :teleport-shield :resist-acid :resist-pressure :weather-dome :mass-resist-lightning :shade :spoof-sensor}
   :water #{:acid-ball :ice-storm :icy-missile :dehydrate :alkahest-sphere :condense-steam :ice-vision :body-of-ice :frost :geyser :freeze :frostbite :dry-spring :distill :ice-dagger :essential-acid :create-steam :icy-breath :flow :coolness :breathe-air :acid-jet :cloud :create-water-elemental :dissipate :mass-coolness :boil-water :create-water :icy-touch :arctic-blast :destroy-water :icy-weapon :create-acid :hail :foul-water :infiltrate :essential-water :breathe-steam :current :alkahest-jet :ice-slick :body-of-water :drown :create-spring :elemental-plumbing :create-ice :earth-to-water :flesh-to-ice :control-water-elemental :fog :cone-of-corrosion :breathe-water :ice-sphere}
   :mind-control #{:mass-charm :hallucination :permanent-madness :great-hallucination :adjuration :forgetfulness :mass-suggestion :oath :panic :wisdom :charm :false-memory :rear-vision :ecstasy :relieve-madness :mass-hallucination :enslave :enthrall :memorize :command :volatility :compel-lie :suggestion :strengthen-will :mass-mutilation :boost-intelligence :sweet-oblivion :encrypt :stabbing-party :drama :pacify :transfer-loyalty :vigil :dream-projection :peaceful-sleep :recall :hypnotize :dull :mind-killer :weaken-will :permanent-forgetfulness :great-geas :know-thyself :disorient :madness :lure :drunkenness :mental-stun :confuse-memory :emotion-control :avoid :writer's-block :mass-daze :berserker :sickness :literary-hunger :lesser-geas :patience :fascinate :dream-sending :bravery :foolishness :glib-tongue :terror :loyalty :daze :keyfinder :alertness :game-addict :coma :startle :will-lock :nightmare :mass-sleep :fear :sleep :dullness :keen :discord :disbelieve :mindlessness :speed-reading}
   :illusion-and-creation #{:duplicate :illusion-disguise :create-servant :simple-illusion :create-mount :dispel-creation :phantom :control-illusion :create-animal :independence :initiative :create-foreign-body :inscribe :phantom-flame :know-illusion :create-object :phantom-killer :perfect-illusion :image :illusion-shell :dispel-illusion :create-warrior :blend-in :mirror :stand-out :gargoyle-skin :create-trap :shadowplay :control-creation :disbelieve :complex-illusion}
   :body-control #{:hold-breath :total-paralysis :belch :boost-strength :haircut :rooted-feet :itch :stop-spasm :transfer-pregnancy :ache :alter-body :transmogrification :enlarge :pain :eat-crow :transform-body :alter-visage :warp-fetus :flexibility :paralyze-limb :hinder :accelerate-pregnancy :might :boost-dexterity :decapitation :partial-mechamorphosis :frailty :curse-missile :elvish-grace :lengthen-limb :mouth-goes-away :ley-running :climbing :death-field :shrink :alter-voice :spasm :perfume :remove-fetus :vigor :doomtouch :clumsiness :stifle :mark-of-thieves :strike-barren :transform-other :roundabout :agonize :strike-anosmic :tickle :reflexes :cadence :resist-pain :balance :shrink-other :ambidexterity :throw-voice :nauseate :corpulence :gauntness :seek-emitter :debility :deathtouch :sensitize :tanglefoot :diver's-blessing :touch :weaken-blood :choke :despoil-seed :sickness :plague-touch :strike-blind :strike-numb :thirst :control-limb :wither-limb :grace :imp-face :boost-health :blend-in :strike-dumb :death :stand-out :strike-deaf :birth-control :ease-labor :stun :enlarge-other :hunger :ether-static :hair-growth :analgesic :fumble :retch}
