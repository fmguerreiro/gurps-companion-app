...
(def spells
  [{:name :small-vision, :prerequisites [#{:keen-vision [5 :light-and-darkness]}], :ref "Magic, p. 111"}
   ...
   {:name :cook, :prerequisites [:test-food :create-fire], :ref "GURPS Magic, p. 78"}
...
(def spells-by-college
  {:fire #{:warmth :resist-fire :seek-fire :flaming-missiles :rain-of-fire :summon-fire-elemental :explosive-fireball :slow-fire :deflect-energy :fire-cloud :phantom-flame :shape-fire :fireproof :ignite-fire :flaming-armor :create-fire-elemental :heat :resist-cold :cold :control-fire-elemental :create-fire :burning-death :smoke :fireball :essential-flame :body-of-flames :flame-jet :flaming-weapon :extinguish-fire :burning-touch :breathe-fire},
   ...
   :body-control #{:hold-breath :total-paralysis :boost-strength :haircut :rooted-feet :itch :stop-spasm :alter-body :transmogrification :enlarge :pain :transform-body :alter-visage :paralyze-limb :hinder :might :boost-dexterity :decapitation :frailty :curse-missile :lengthen-limb :mouth-goes-away :climbing :shrink :alter-voice :spasm :perfume :vigor :clumsiness :mark-of-thieves :strike-barren :transform-other :roundabout :agonize :tickle :reflexes :cadence :resist-pain :balance :shrink-other :ambidexterity :nauseate :corpulence :gauntness :seek-emitter :debility :deathtouch :sensitize :tanglefoot :touch :weaken-blood :choke :despoil-seed :sickness :strike-blind :strike-numb :thirst :control-limb :wither-limb :grace :imp-face :boost-health :strike-dumb :strike-deaf :stun :enlarge-other :hunger :hair-growth :fumble :retch},
...
(def vh-spells
  #{:hybrid-control :repel-hybrids :permanent-beast-possession :shapeshifting :shapeshift-others :permanent-shapeshifting :partial-shapeshifting :great-shapeshift :shrink :shrink-other :enlarge :enlarge-other :corpulence :gauntness :gift-of-tongues :gift-of-letters :mind-search :telepathy :communication :possession :permanent-possession :exchange-bodies :partial-petrifaction :body-of-stone :alter-terrain :move-terrain :enchant :lesser-wish :golem :malefice :ensorcel :wish :simulacrum :doppelganger :great-wish :weapon-spirit :blank-spell-arrow :effigy :soul-stone :breathe-fire :body-of-flames :burning-death :timeport :timeport-other :rapid-journey :planar-visit :plane-shift :phase-other :divert-teleport :create-gate :slow-time :accelerate-time :sanctuary :suspend-time :time-out :great-healing :major-healing :instant-neutralize-poison :restoration :instant-restoration :regeneration :instant-regeneration :youth :halt-aging :resurrection :phantom :create-object :duplicate :summon-shade :body-of-shadow :inspired-creation :shatter :animate-object :rive :explode :weapon-self :transform-object :contract-object :extend-object :shrink-object :enlarge-object :disintegrate :catch-spell :suspend-mana :charge-powerstone :spellguard :drain-mana :restore-mana :steal-spell :telecast :hang-spell :maintain-spell :suspend-magery :drain-magery :alertness :dullness :mindlessness :permanent-forgetfulness :ecstasy :permanent-madness :lesser-geas :enslave :great-hallucination :great-geas :flight :flying-carpet :hawk-flight :ethereal-body :great-haste :teleport :teleport-other :blink-other :cloud-vaulting :animation :mass-zombie :age :evisceration :rotting-death :soul-jar :bind-spirit :steal-might :steal-dexterity :steal-wisdom :steal-vigor :steal-youth :steal-beauty :lich :wraith :plant-form-other :reflect-gaze :schematic :rebuild :animate-machine :permanent-machine-possession :awaken-computer :conduct-power :steal-power :draw-power :spectrum-vision :extinguish-radiation :cure-radiation :breathe-radiation :body-of-metal :body-of-plastic :body-of-ice :flesh-to-ice :geyser :icy-breath :spit-acid :essential-acid :breathe-steam})
