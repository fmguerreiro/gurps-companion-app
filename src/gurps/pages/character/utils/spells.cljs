...
(def spells
  [{:name :small-vision, :prerequisites [#{:keen-vision [5 :light-and-darkness]}], :ref "Magic, p. 111"}
   ...
   {:name :hold-breath, :prerequisites [[:skills/magery 1] :vigor], :ref "Magic, p. 39"}
   ...
   {:name :great-wish, :prerequisites [[:skills/magery 3] :wish [:attributes/int 20]], :ref "Magic p. 61"}
   ...
   {:name :broadcast-spell, :prerequisites [[:skills/magery 3] :telepathy :mass-suggestion [:world/tl 6]], :ref "Classic: Technomander p. 19"}
   ...
   {:name :alter-terrain, :prerequisites [[:skills/magery 3] :shape-fire :shape-stone :shape-water :shape-air], :ref "Magic, p. 55"}
   ...
   {:name :mass-charm, :prerequisites [[:skills/magery 2] [:attributes/int 13] :charm], :ref "Magic Styles: Dungeon Magic, p. 31"}
   {:name :swim, :prerequisites [:shape-water :levitation], :ref "Magic p. 147"}
   {:name :partial-petrification, :prerequisites [[:skills/magery 2] :flesh-to-stone], :ref "Magic, p. 52"}
   ...
   {:name :great-shapeshift, :prerequisites [[:skills/magery 3] :alter-body [4 :shapeshifting]], :ref "Magic p. 34"}
   ...
   {:name :create-servant, :prerequisites [[:skills/magery 3] [:attributes/int 12] :create-object], :ref "Magic p. 98"}
   ...
   {:name :permanent-madness, :prerequisites [[:skills/magery 2] :madness [:attributes/int 13]], :ref "Magic p. 139"}
   {:name :suspend-magery, :prerequisites [[:skills/magery 2] :2-each-from-10-colleges], :ref "Magic p. 130"}
   {:name :transfer-pregnancy, :prerequisites [[:skills/magery 2] :remove-fetus], :ref "GURPS Bio-Tech, p. 32"}
   ...
   {:name :counterspell, :prerequisites [[:skills/magery 1] :spell-being-countered], :ref "Basic Set, p. 250; Magic p. 121"}
   ...
   {:name :transmogrification, :prerequisites [[:skills/magery 3] :transform-other :transform-object :flesh-to-stone.], :ref "Magic, p. 43"}
   {:name :copy, :prerequisites [:dye :1-written-language-at-accented], :ref "Magic p. 116"}
   {:name :far-hearing, :prerequisites [[:skills/magery 1] [4 :sound]], :ref "Magic, p. 173"}
   {:name :condense-steam, :prerequisites [#{:boil-water :cold}], :ref "Magic p. 189"}
   {:name :mass-invisibility, :prerequisites [[:skills/magery 2] [:attributes/int 13] :hallucination], :ref "Magic Styles: Dungeon Magic, p. 32"}
   {:name :great-hallucination, :prerequisites [[:skills/magery 2] :hallucination], :ref "Magic p. 141"}
   ...
   {:name :enlarge, :prerequisites [[:skills/magery 2] :alter-body], :ref "Magic, p. 42; Pyramid 3/60: Dungeon Fantasy III, p. 5"}
   {:name :far-feeling, :prerequisites [[:skills/magery 1]], :ref "Magic, p. 100"}
   {:name :forgetfulness, :prerequisites [[:skills/magery 1] :foolishness], :ref "Basic Set p. 250; Magic p. 135"}
   ...
   {:name :simulacrum, :prerequisites [[:skills/magery 3] :golem :perfect-illusion :illusion-disguise], :ref "Magic p. 61"}
   ...
   {:name :lockmaster, :prerequisites [[:skills/magery 2] :apportation], :ref "Basic Set, p. 251; Magic p. 144"}
   {:name :pain, :prerequisites [:spasm], :ref "Magic, p. 36"}
   {:name :rain-of-stones, :prerequisites [[:skills/magery 2] :create-earth], :ref "Magic, p. 53"}
   ...
   {:name :detect-magic, :prerequisites [[:skills/magery 1]], :ref "Basic Set, p. 249; Magic, p. 101"}
   ...
   {:name :recover-energy, :prerequisites [[:skills/magery 1] :lend-energy], :ref "Basic Set, p. 248; Magic p. 89"}
   {:name :simple-illusion, :prerequisites [:no-blindness [:iq 11]], :ref "Magic p. 95; Fantasy, p. 170; 'Social Engineering: Back to School, p. 24"}
   ...
   {:name :oath, :prerequisites [[:skills/magery 1] :emotion-control], :ref "Magic p. 138"}
   ...
   {:name :ward, :prerequisites [[:skills/magery 1]], :ref "Magic p. 122; Thaumatology: Urban Magics"}
   ...
   {:name :shapeshift-others, :prerequisites [[:skills/magery 2] :shapeshifting], :ref "Magic p. 33"}
   ...
   {:name :spider-silk, :prerequisites [[:skills/magery 1] [2 :animal]], :ref "Magic p. 32"}
   ...
   {:name :ruin, :prerequisites [[:skills/magery 1] :weaken :decay], :ref "Magic p. 118"}
   {:name :wisdom, :prerequisites [[6 :other]], :ref "Magic p. 135; Social Engineering: Back to School, p. 24"}
   {:name :timeport, :prerequisites [[:skills/magery 3] :teleport], :ref "Magic p. 81"}
   {:name :alter-visage, :prerequisites [[:skills/magery 1] #{:perfect-illusion :shapeshifting} [8 :body-control]], :ref "Magic, p. 41"}
   {:name :explosive-lightning, :prerequisites [:lightning], :ref "Magic p. 196"}
   {:name :imitate-voice, :prerequisites [:voices], :ref "Magic p. 172"}
   {:name :remove-curse, :prerequisites [[:skills/magery 2] :1-spell-from-each-of-15-colleges], :ref "Magic p. 126; Thaumatology: Urban Magics"}
   ...
   {:name :charm, :prerequisites [[:skills/magery 1] :loyalty [7 :other]], :ref "Magic p. 139"}
   {:name :distill, :prerequisites [:mature :destroy-water], :ref "GURPS Magic, p. 89"}
   {:name :create-mount, :prerequisites [[:skills/magery 3] :create-animal], :ref "Magic p. 99"}
   ...
   {:name :great-haste, :prerequisites [[:skills/magery 1] [:attributes/int 12] :haste], :ref "Basic Set, p. 251; Magic p. 146"}
   ...
   {:name :doppelganger, :prerequisites [[:skills/magery 3] :golem :history :enslave], :ref "Magic p. 62; Classic: Magic p 40"}
   ...
   {:name :scryguard, :prerequisites [[:skills/magery 1]], :ref "GURPS Fantasy, p. 170; Thaumatology: Urban Magics"}
   ...
   {:name :phantom, :prerequisites [[:skills/magery 2] :perfect-illusion :hinder :apportation], :ref "Magic p. 97"}
   ...
   {:name :paralyze-limb, :prerequisites [[:skills/magery 1] :pain [4 :other]], :ref "Basic Set, p. 244; Magic, p. 40"}
   {:name :icy-breath, :prerequisites [[:advantages/magery 1] :snow-jet :resist-cold], :ref "Magic p. 192"}
   {:name :shield, :prerequisites [[:skills/magery 2]], :ref "Basic Set, p. 252; Magic p. 167"}
   ...
   {:name :curse, :prerequisites [[:skills/magery 2] :2-each-from-10-colleges], :ref "Magic p. 129"}
   ...
   {:name :catch-spell, :prerequisites [[:skills/magery 2] [:attributes/dex 12] :return-missile], :ref "Magic p. 123"}
   {:name :rain-of-fire, :prerequisites [[:skills/magery 2] :create-fire], :ref "Magic p. 74; Pyramid 3/60: Dungeon Fantasy III, p. 5"}
   {:name :ecstasy, :prerequisites [[:skills/magery 2] :emotion-control], :ref "Magic p. 139"}
   {:name :summon-fire-elemental, :prerequisites [[:skills/magery 1] #{[[8 :fire]] [[4 :fire] #{:summon-water-elemental :summon-air-elemental :summon-earth-elemental}]}], :ref "Magic p. 27"}
   ...
   {:name :decapitation, :prerequisites [[:skills/magery 2] :alter-body], :ref "Magic, p. 42"}
   {:name :flying-carpet, :prerequisites [:flight :or-magery-2 :walk-on-air], :ref "Magic p. 145"}
   {:name :major-healing, :prerequisites [[:skills/magery 1] :minor-healing], :ref "Basic Set, p. 248; Magic p. 91"}
   ...
   {:name :summon-air-elemental, :prerequisites [[:skills/magery 1] [4 :air] #{:summon-water-elemental :summon-fire-elemental :summon-earth-elemental}], :ref "Magic p. 27"}
   ...
   {:name :rapid-journey, :prerequisites [[:skills/magery 3] #{:timeport :teleport}], :ref "Magic p. 82"}
   {:name :banish, :prerequisites [[:advantages/magery 1] :1-spell-each-from-10-colleges], :ref "Magic p. 156"}
   ...
   {:name :curse-missile, :prerequisites [[:skills/magery 2] :curse], :ref "Classic: Magic p 24"}
   {:name :lightning, :prerequisites [[:skills/magery 1] [6 :other]], :ref "Basic Set p. 244; Magic p. 196"}
   ...
   {:name :possession, :prerequisites [[:skills/magery 1] #{:control-person :beast-possession}], :ref "Magic, p. 49"}
   {:name :mass-hallucination, :prerequisites [[:skills/magery 2] [:attributes/int 13] :hallucination], :ref "Magic Styles: Dungeon Magic, p. 32"}
   {:name :create-water-elemental, :prerequisites [[:advantages/magery 2] :control-water-elemental], :ref "Magic p. 22"}
   {:name :accelerate-time, :prerequisites [[:skills/magery 2] [:attributes/int 13] :2-each-from-10-colleges], :ref "Magic p. 86"}
   {:name :echoes-of-the-past, :prerequisites [[:skills/magery 2] :history :voices], :ref "Magic, p. 107"}
   {:name :enslave, :prerequisites [:charm :telepathy], :ref "Magic p. 141"}
   {:name :halt-aging, :prerequisites [[:skills/magery 2] [8 :healing]], :ref "Magic p. 94"}
   {:name :shatter, :prerequisites [[:skills/magery 1] :weaken], :ref "Magic p. 116"}
   {:name :lengthen-limb, :prerequisites [[:skills/magery 3] :shapeshifting], :ref "Magic, p. 42; b: Classic Grimoire p. 18"}
   {:name :explosive-fireball, :prerequisites [:fireball], :ref "Basic Set, p. 247; Magic p. 75"}
   {:name :seek-gate, :prerequisites [[:skills/magery 2] :seek-magic :1-spell-from-each-of-10-colleges], :ref "Magic p. 85"}
   ...
   {:name :freedom, :prerequisites [[3 :body] [3 :movement] :3-protectio :warning], :ref "Magic p. 148"}
   {:name :dancing-object, :prerequisites [[:skills/magery 2] :apportation], :ref "Magic p. 144, Classic Magic p 61"}
   ...
   {:name :mouth-goes-away, :prerequisites [[:skills/magery 1] :alter-visage [4 :body-control]], :ref "Alphabet Arcane, p. 17"}
   ...
   {:name :air-vortex, :prerequisites [[:skills/magery 2] :body-of-air :windstorm], :ref "Magic p. 26"}
   ...
   {:name :shrink, :prerequisites [[:skills/magery 2] :alter-body], :ref "Magic, p. 42"}
   ...
   {:name :body-of-wind, :prerequisites [[:skills/magery 3] [:body-of-air 16] [:windstorm 16] {:fire 1, :water 1, :earth 1, :ether 1}], :ref "Magic p. 27"}
   ...
   {:name :repair, :prerequisites [[:skills/magery 2] :rejoin], :ref "Magic p. 118"}
   {:name :command, :prerequisites [[:skills/magery 2] :forgetfulness], :ref "Basic Set, p. 251; Magic p. 136"}
   ...
   {:name :suspend-time, :prerequisites [[:skills/magery 3] :slow-time], :ref "Magic p. 86"}
   {:name :seek-earth, :prerequisites [], :ref "Basic Set, p. 245; Magic, p. 50"}
   {:name :noise, :prerequisites [:wall-of-silence], :ref "Magic p. 173"}
   {:name :phase, :prerequisites [[:skills/magery 3] #{:ethereal-body :plane-shift}], :ref "Magic p. 83"}
   {:name :perfume, :prerequisites [:odor], :ref "Magic, p. 35"}
   {:name :compel-lie, :prerequisites [:emotion-control], :ref "Magic, p. 137"}
   {:name :animate-object, :prerequisites [[:skills/magery 2] [3 :shape]], :ref "Magic p. 117"}
   ...
   {:name :distant-blow, :prerequisites [[:skills/magery 2] :apportation], :ref "Magic p. 144"}
   ...
   {:name :strengthen-will, :prerequisites [[:skills/magery 1] [6 :mind]], :ref "Magic p. 136"}
   ...
   {:name :suspend-curse, :prerequisites [[:skills/magery 1] :1-spell-each-from-12-colleges], :ref "Magic p. 125"}
   ...
   {:name :great-ward, :prerequisites [[:skills/magery 2] :ward], :ref "Magic p. 122"}
   ...
   {:name :deflect-energy, :prerequisites [[:skills/magery 1] :shape-fire], :ref "Basic Set, p. 246; Magic p. 73"}
   ...
   {:name :telecast, :prerequisites [[:skills/magery 3] :teleport :wizard-eye :1-spell-each-from-10-colleges], :ref "Magic p. 128"}
   ...
   {:name :drain-magery, :prerequisites [[:skills/magery 3] :suspend-magery], :ref "Magic p. 130"}
   {:name :icy-touch, :prerequisites [[:advantages/magery 1] [5 :water]], :ref "Magic p. 188"}
   {:name :time-out, :prerequisites [[:skills/magery 3] :accelerate-time], :ref "Magic p. 87"}
   {:name :resist-poison, :prerequisites [:vigor], :ref "Magic p. 91"}
   {:name :bless, :prerequisites [[:skills/magery 2] :2-each-from-10-colleges], :ref "Magic p. 129"}
   {:name :mark-of-thieves, :prerequisites [[:skills/magery 1] :pestilence], :ref "Alphabet Arcane, p. 17"}
   ...
   {:name :know-location, :prerequisites [[:skills/magery 1] :tell-position], :ref "Magic, p. 103"}
   {:name :repel-spirits, :prerequisites [:banish :turn-spirit], :ref "Magic p. 158"}
   {:name :entombment, :prerequisites [[:skills/magery 2] [5 :earth]], :ref "Basic Set, p. 246; Magic, p. 53"}
   ...
   {:name :pacify, :prerequisites [[:skills/magery 2] :persuasion :relieve-madness], :ref "Magic Styles: Dungeon Magic, p. 24"}
   ...
   {:name :permanent-shapeshifting, :prerequisites [[:skills/magery 3] :appropriate-shapeshifting], :ref "Magic p. 33"}
   ...
   {:name :vigil, :prerequisites [[:skills/magery 2] :sleep :lend-energy], :ref "Magic p. 138"}
   {:name :strike-barren, :prerequisites [[:skills/magery 1] :steal-vitality :decay], :ref "Magic, p. 41"}
   ...
   {:name :partial-shapeshifting, :prerequisites [[:skills/magery 3] :alter-body :shapeshifting], :ref "Magic p. 34"}
   {:name :recall, :prerequisites [[:skills/magery 2] :memorize :history], :ref "Magic, p. 104"}
   {:name :dull, :prerequisites [], :ref "Magic p. 133"}
   {:name :roundabout, :prerequisites [:tanglefoot], :ref "Magic, p. 36"}
   {:name :agonize, :prerequisites [[:skills/magery 2] :sensitize], :ref "Magic, p. 40"}
   ...
   {:name :weaken-will, :prerequisites [[:skills/magery 1] :foolishness], :ref "Magic p. 136"}
   {:name :tickle, :prerequisites [:spasm], :ref "Magic, p. 36"}
   {:name :sovereign-countermagic, :prerequisites [[:skills/magery 3] :analyze-magic :dispel-magic], :ref "Magic Styles: Dungeon Magic, p. 28"}
   {:name :create-object, :prerequisites [[:skills/magery 2] :create-earth :perfect-illusion], :ref "Magic p. 98"}
   {:name :permanent-forgetfulness, :prerequisites [[:skills/magery 2] :forgetfulness [:attributes/int 13]], :ref "Magic p. 138"}
   ...
   {:name :great-geas, :prerequisites [[:skills/magery 3] [15 :mind] :lesser-geas], :ref "Magic p. 141; Social Engineering: Back to School, p. 24"}
   ...
   {:name :rive, :prerequisites [[:skills/magery 2] :shatter], :ref "Magic p. 117"}
   ...
   {:name :suspend-mana, :prerequisites [:suspend-magic :1-spell-each-from-10-colleges], :ref "Magic p. 125"}
   ...
   {:name :final-rest, :prerequisites [#{[:skills/magery 1] :spirit-empathy}], :ref "Magic p. 89"}
   ...
   {:name :slow-time, :prerequisites [[:skills/magery 2] [:attributes/int 13] :2-from-each-of-10-colleges], :ref "Magic p. 86"}
   ...
   {:name :utter-dome, :prerequisites [[:skills/magery 2] :force-dome :spell-shield], :ref "Magic p. 170"}
   ...
   {:name :restore-memory, :prerequisites [:awaken [:iq 11]], :ref "Magic p. 92"}
   ...
   {:name :resist-pain, :prerequisites [[:skills/magery 2] :pain], :ref "Magic, p. 38"}
   ...
   {:name :compel-truth, :prerequisites [[:skills/magery 2] :truthsayer], :ref "Magic, p. 47"}
   {:name :shocking-touch, :prerequisites [:lightning], :ref "Magic p. 196"}
   {:name :lend-energy, :prerequisites [#{[:skills/magery 1] :empathy}], :ref "Basic Set, p. 248; Magic p. 89"}
   ...
   {:name :pathfinder, :prerequisites [[:skills/magery 1] [:attributes/int 12] [2 :seek]], :ref "Magic, p. 105"}
   ...
   {:name :cloud-vaulting, :prerequisites [[:skills/magery 2] :jump :walk-on-air], :ref "Magic p. 148"}
   {:name :body-of-air, :prerequisites [:shape-air], :ref "Magic p. 24"}
   {:name :far-tasting, :prerequisites [[:skills/magery 1] #{:seek-food :seek-air}], :ref "Magic, p. 77"}
   {:name :images-of-the-past, :prerequisites [[:skills/magery 2] :history :simple-illusion], :ref "Magic, p. 105"}
   {:name :ignite-fire, :prerequisites [], :ref "Basic Set, p. 246; Magic p. 72"}
   {:name :permanent-possession, :prerequisites [[:skills/magery 3] :possession], :ref "Magic, p. 49"}
   ...
   {:name :weapon-self, :prerequisites [[:skills/magery 2] :apportation :6-makin [:breaking :reshape]], :ref "Magic p. 119"}
   {:name :sound-vision, :prerequisites [#{:acute-hearing :keen-hearing}], :ref "Magic p. 171"}
   {:name :shrink-other, :prerequisites [[:skills/magery 3] :shrink], :ref "Magic, p. 42"}
   {:name :resist-water, :prerequisites [#{:shape-water :umbrella} :destroy-water], :ref "Magic p. 186"}
   {:name :flaming-armor, :prerequisites [[:skills/magery 1] :resist-fire :flame-jet], :ref "Magic p. 75"}
   ...
   {:name :create-fire-elemental, :prerequisites [[:skills/magery 2] :control-fire-elemental], :ref "Magic p. 22"}
   {:name :rebuild, :prerequisites [[:skills/magery 3] :repair :create-object [3 :air] [3 :water] [3 :fire] [3 :earth]], :ref "Magic p. 177"}
   ...
   {:name :corpulence, :prerequisites [[:skills/magery 2] :create-earth :create-water :alter-body [3 :body-control]], :ref "Magic, p. 43"}
   {:name :machine-control, :prerequisites [:reveal-function :locksmith :lightning], :ref "Magic p. 176"}
   {:name :planar-summons, :prerequisites [[:skills/magery 1] :1-spell-from-10-other-colleges], :ref "Basic Set p. 247; Magic p. 82"}
   ...
   {:name :scroll, :prerequisites [[:skills/magery 1] [:skills/writing 12]], :ref "Magic p. 57"}
   {:name :contract-object, :prerequisites [[:skills/magery 3] :transform-object], :ref "Magic p. 120"}
   ...
   {:name :gauntness, :prerequisites [[:skills/magery 2] :earth-to-air :destroy-water :hunger [3 :body-control]], :ref "Magic, p. 43"}
   ...
   {:name :magic-resistance, :prerequisites [[:skills/magery 1] :1-spell-each-from-7-colleges], :ref "Magic p. 123"}
   ...
   {:name :sensitize, :prerequisites [[:skills/magery 1] :stun], :ref "Magic, p. 39"}
   {:name :seeker, :prerequisites [[:skills/magery 1] [:attributes/int 12] :2-'seek-'spells], :ref "Basic Set, p. 249; Magic, p. 105"}
   ...
   {:name :perfect-illusion, :prerequisites [[:skills/magery 1] :complex-illusion], :ref "Magic p. 96; 'Social Engineering: Back to School, p. 24"}
   {:name :current, :prerequisites [[6 :water]], :ref "Magic p. 194"}
   {:name :invisibility, :prerequisites [[:skills/magery 2] [:attributes/int 13]], :ref "Magic p. 114; Fantasy, p. 170; Pyramid 3/60: Dungeon Fantasy III, p. 5"}
   ...
   {:name :weaken-blood, :prerequisites [[:skills/magery 1] #{:steal-vitality :sickness}], :ref "Magic, p. 40"}
   {:name :wall-of-lightning, :prerequisites [:lightning], :ref "Magic p. 197"}
   {:name :air-vision, :prerequisites [:shape-air], :ref "Magic p. 24"}
   {:name :choke, :prerequisites [[:skills/magery 1] [5 :body-control] :spasm], :ref "Magic, p. 40"}
   {:name :despoil-seed, :prerequisites [[:skills/magery 1] :alter-body :strike-barren], :ref "Alphabet Arcane, p. 17"}
   ...
   {:name :reshape, :prerequisites [[:skills/magery 1] :weaken #{:shape-earth :shape-plant}], :ref "Magic p. 117"}
   {:name :sickness, :prerequisites [#{[:skills/magery 1] :drunkenness} :pestilence], :ref "Magic, p. 138"}
   {:name :animal-control, :prerequisites [:beast-soother], :ref "Magic p. 30"}
   {:name :lesser-geas, :prerequisites [[:skills/magery 2] [10 :mind]], :ref "Magic p. 140; Social Engineering: Back to School, p. 24"}
   ...
   {:name :youth, :prerequisites [[:skills/magery 3] :halt-aging], :ref "Magic p. 94"}
   ...
   {:name :strike-blind, :prerequisites [:spasm :2-light :darkness-spells], :ref "Magic, p. 38"}
   {:name :strike-numb, :prerequisites [:resist-pain], :ref "Magic, p. 40"}
   {:name :summon-earth-elemental, :prerequisites [[:skills/magery 1] #{[[8 :earth]] [[4 :earth] #{:summon-water-elemental :summon-fire-elemental :summon-air-elemental}]}], :ref "Magic, p. 27"}
   {:name :lend-spell, :prerequisites [[:skills/magery 1] :lend-skill :1-spell-each-from-6-colleges], :ref "Magic p. 126"}
   {:name :thirst, :prerequisites [[:skills/magery 1] :debility :destroy-water], :ref "Magic, p. 38"}
   ...
   {:name :deflect-missile, :prerequisites [:apportation], :ref ""}
   {:name :lightning-stare, :prerequisites [:lightning :resist-lightning], :ref "Magic p. 198"}
   {:name :instant-regeneration, :prerequisites [[:skills/magery 3] :regeneration], :ref "Magic p. 93"}
   {:name :foolishness, :prerequisites [[:attributes/int 12]], :ref "Basic Set p. 250; Magic p. 134"}
   {:name :earthquake, :prerequisites [[:skills/magery 2] [6 :earth] :earth-vision], :ref "Magic, p. 54"}
   ...
   {:name :enchant, :prerequisites [[:skills/magery 2] [:gate 1] [:body-control 1] [:movement 1] [:food 1] [:sound 1] [:illusion-and-creation 1] [:knowledge 1] [:protection-and-warning 1] [:meta 1] [:light-and-darkness 1]], :ref "Basic Set, p. 480; Magic p. 56"}
   ...
   {:name :scents-of-the-past, :prerequisites [[:skills/magery 2] :history :odor], :ref "Magic, p. 107"}
   {:name :create-fire, :prerequisites [#{:seek-fire :ignite-fire}], :ref "Magic p. 72"}
   {:name :regeneration, :prerequisites [[:skills/magery 2] :restoration], :ref "Magic p. 93"}
   ...
   {:name :burning-death, :prerequisites [[:skills/magery 2] :heat :sickness], :ref "Magic p. 76"}
   ...
   {:name :control-limb, :prerequisites [[:skills/magery 1] [5 :body-control] :spasm], :ref "Magic, p. 40; Classic Grimoire p 14"}
   ...
   {:name :seek-number, :prerequisites [[:skills/magery 1] [:world/tl 6]], :ref "Technomancer p. 18"}
   {:name :mage-stealth, :prerequisites [:hush], :ref "Magic p. 172"}
   {:name :disintegrate, :prerequisites [[:skills/magery 2] :shatter :ruin :earth-to-air :destroy-air :destroy-water], :ref "Magic p. 120"}
   ...
   {:name :know-true-shape, :prerequisites [[:skills/magery 1] [1 :shifting] #{:know-illusion :aura}], :ref "Magic, p. 104"}
   {:name :wither-limb, :prerequisites [[:skills/magery 2] :paralyze-limb], :ref "Basic Set, p. 244; Magic, p. 40"}
   {:name :wizard-nose, :prerequisites [:apportation :far-tasting], :ref "Magic, p. 104"}
   {:name :neutralize-poison, :prerequisites [#{:cure-disease [:skills/magery 3]} :test-food], :ref "Magic p. 92"}
   ...
   {:name :fireball, :prerequisites [[:skills/magery 1] :create-fire :shape-fire], :ref "Basic Set, p. 247; Magic p. 74"}
   ...
   {:name :imp-face, :prerequisites [[:skills/magery 1] :planar-summons :alter-visage], :ref "Alphabet Arcane, p. 17"}
   {:name :boost-health, :prerequisites [:vigor], :ref "Magic, p. 37"}
   {:name :loyalty, :prerequisites [:bravery [2 :other]], :ref "Magic p. 136"}
   ...
   {:name :explode, :prerequisites [[:skills/magery 2] :shatter :apportation], :ref "Magic p. 118"}
   ...
   {:name :create-earth-elemental, :prerequisites [[:skills/magery 2] :control-earth-elemental], :ref "Magic, p. 22"}
   {:name :daze, :prerequisites [:foolishness], :ref "Basic Set'', p. 250; Magic p. 134"}
   {:name :flight, :prerequisites [[:skills/magery 2] :levitation], :ref "Magic p. 145; Fantasy, p. 171"}
   {:name :spell-stone, :prerequisites [:enchant :delay], :ref "Magic p. 60"}
   {:name :plane-shift-other, :prerequisites [[:skills/magery 3] :plane-shift], :ref "Magic p. 83"}
   {:name :seek-air, :prerequisites [], :ref "Magic p. 23"}
   {:name :great-healing, :prerequisites [[:skills/magery 3] :major-healing], :ref "Basic Set, p. 248; Magic p. 91"}
   ...
   {:name :earth-to-water, :prerequisites [[:skills/magery 1] :create-water :shape-earth], :ref "Magic, p. 52"}
   {:name :rotting-death, :prerequisites [[:skills/magery 2] :sickness :pestilence], :ref "Magic p. 154"}
   {:name :lend-skill, :prerequisites [:mind-sending [:iq 11]], :ref "Magic, p. 47; Social Engineering: Back to School, p. 24"}
   {:name :see-invisible, :prerequisites [#{:invisibility :infravision :dark-vision}], :ref "Magic p. 113"}
   {:name :alertness, :prerequisites [[:skills/magery 2] :create-acid], :ref "Magic p. 133; Classic: Magic p 69"}
   {:name :machine-summoning, :prerequisites [:machine-control], :ref "Magic, p. 176"}
   {:name :permanent-beast-possession, :prerequisites [[:skills/magery 2] :beast-possession], :ref "Magic p. 32"}
   {:name :master, :prerequisites [:beast-soother], :ref "Magic p. 30"}
   {:name :mud-jet, :prerequisites [:water-jet :create-earth :or-create-water :s :jet], :ref "Magic, p. 52"}
   {:name :strike-dumb, :prerequisites [:spasm], :ref "Magic, p. 38"}
   {:name :mirror, :prerequisites [:colors], :ref "Magic p. 112"}
   {:name :planar-visit, :prerequisites [[:skills/magery 2] #{:planar-summons :projection}], :ref "Magic p. 82"}
   {:name :apportation, :prerequisites [[:skills/magery 1]], :ref "Basic Set, p. 251; Magic p. 142"}
   {:name :control-air-elemental, :prerequisites [:summon-air-elemental], :ref "Magic p. 28"}
   {:name :stone-to-flesh, :prerequisites [[:skills/magery 2] :flesh-to-stone :stone-to-earth], :ref "Basic Set, p. 246; Magic, p. 53"}
   ...
   {:name :mind-over-matter, :prerequisites [[:skills/magery 2] [1 :divination]], :ref "Magic Styles: Dungeon Magic, p. 27"}
   {:name :sanctuary, :prerequisites [:hide-object], :ref "Magic p. 86"}
   {:name :light, :prerequisites [], :ref "Basic Set p. 253; Magic p. 110"}
   {:name :pull, :prerequisites [[:skills/magery 2] [4 :movement] :levitation], :ref "Magic p. 146"}
   {:name :spell-shield, :prerequisites [[:skills/magery 2] :scryguard :magic-resistance], :ref "Magic p. 124"}
   ...
   {:name :suspend-spell, :prerequisites [[:skills/magery 1]], :ref "Magic p. 121; Thaumatology: Urban Magics"}
   {:name :stun, :prerequisites [:pain], :ref "Magic, p. 37"}
   {:name :sovereign-ward, :prerequisites [[:skills/magery 3] :dispel-magic :ward], :ref "Magic Styles: Dungeon Magic, p. 28"}
   ...
   {:name :nightmare, :prerequisites [[:skills/magery 2] :death-vision :fear :sleep], :ref "Magic p. 140"}
   ...
   {:name :find-direction, :prerequisites [[:skills/magery 1]], :ref "Magic, p. 101"}
   {:name :enlarge-other, :prerequisites [[:skills/magery 3] :enlarge], :ref "Magic, p. 43; Pyramid 3/60: Dungeon Fantasy III, p. 5"}
   ...
   {:name :healing-slumber, :prerequisites [[:skills/magery 2] :sleep :minor-healing], :ref "Magic p. 94"}
   ...
   {:name :repel, :prerequisites [[:skills/magery 2] [4 :movement] :levitation], :ref "Magic p. 146"}
   ...
   {:name :control-gate, :prerequisites [[:skills/magery 3] :seek-gate], :ref "Magic p. 85"}
   {:name :sense-foes, :prerequisites [], :ref "Basic Set, p. 245; Magic, p. 44"}
   {:name :instant-neutralize-poison, :prerequisites [[:skills/magery 2] :neutralize-poison], :ref "Magic p. 92"}
   ...
   {:name :mana-vortex, :prerequisites [[:skills/magery 2] :lend-energy :sense-danger], :ref "Magic Styles: Dungeon Magic, p. 27; Thaumatology: Urban Magics"}
   {:name :reconstruct-spell, :prerequisites [[:skills/magery 2] :history :identify-spell], :ref "Magic, p. 104"}
   ...
   {:name :sunbolt, :prerequisites [:6-ligh [:darkness :sunlight]], :ref "Magic p. 114"}
   {:name :shapeshifting, :prerequisites [[:skills/magery 1] [6 :animal]], :ref "Magic p. 32-33"}
   {:name :purify-air, :prerequisites [], :ref "Basic Set p. 243; Magic p. 23; Classic: Technomanser p 17"}
   {:name :instant-restoration, :prerequisites [[:skills/magery 2] :restoration], :ref "Magic p. 93"}
   {:name :flaming-weapon, :prerequisites [[:skills/magery 2] :heat], :ref "Magic p. 75"}
   {:name :extinguish-fire, :prerequisites [:ignite-fire], :ref "Basic Set, p. 247; Magic p. 72"}
   {:name :hunger, :prerequisites [[:skills/magery 1] :debility :decay], :ref "Magic, p. 38"}
   ...
   {:name :teleport-other, :prerequisites [[:skills/magery 3] :teleport], :ref "Magic p. 147"}
   {:name :machine-speech, :prerequisites [:machine-summoning], :ref "Magic, p. 176"}
   {:name :keen, :prerequisites [], :ref "Magic p. 133"}
   {:name :discord, :prerequisites [[:skills/magery 2] :emotion-control :vexation], :ref "Magic Styles: Dungeon Magic, p. 31"}
   ...
   {:name :steelwraith, :prerequisites [[:skills/magery 2] :walk-through-earth], :ref "Magic, p. 54; Pyramid 3/60: Dungeon Fantasy III, p. 5"}
   {:name :burning-touch, :prerequisites [[:skills/magery 2] [6 :fire] :heat], :ref "Magic p. 76"}
   {:name :metal-vision, :prerequisites [:shape-metal], :ref "Magic, p. 183"}
   {:name :body-of-shadow, :prerequisites [[:skills/magery 2] :shape-darkness], :ref "M114"}
   ...
   {:name :find-weakness, :prerequisites [:1-spell-from-each-of-4-elements], :ref "Magic p. 116"}
   ...
   {:name :mind-whip, :prerequisites [[:skills/magery 2] :telepathy :thunderclap], :ref "Magic Styles: Dungeon Magic, p. 24"}
   {:name :reflect, :prerequisites [:ward], :ref "Magic p. 122; Thaumatology: Urban Magics"}
   {:name :lightning-weapon, :prerequisites [[:skills/magery 2] :lightning], :ref "Magic p. 198"}
   {:name :hair-growth, :prerequisites [[5 :body-control]], :ref "Magic, p. 39"}
   {:name :earth-to-stone, :prerequisites [[:skills/magery 1] :shape-earth], :ref "Magic, p. 51; Pyramid 3/60: Dungeon Fantasy III, p. 6"}
   {:name :toughen, :prerequisites [:shatterproof], :ref "Magic p. 119"}
   {:name :body-of-lightning, :prerequisites [[:skills/magery 2] :lightning], :ref "Magic p. 198"}
   ...
   {:name :stop-paralysis, :prerequisites [:minor-healing :paralyze-limb :or-strike-dumb], :ref "Magic p. 93"}
   {:name :poison-food, :prerequisites [:purify-food :decay], :ref "GURPS Magic, p. 78"}
   {:name :fumble, :prerequisites [:clumsiness], :ref "Magic, p. 38"}
   {:name :breathe-fire, :prerequisites [[:skills/magery 1] :flame-jet :resist-fire], :ref "Magic p. 76"}
   ...
   {:name :mindlessness, :prerequisites [[:skills/magery 2] :forgetfulness], :ref "Magic p. 137"}
   ...
   {:name :create-air-elemental, :prerequisites [[:skills/magery 2] :control-air-elemental], :ref "Magic p. 22"}
   {:name :disrupt, :prerequisites [[:skills/magery 2] :concussion :sound-jet :secret-spell], :ref "Magic Styles: Dungeon Magic p. 23"}
   ...
   {:name :sunlight, :prerequisites [[:skills/magery 1] :glow :colors], :ref "Magic p. 114"}
   ...
   {:name :extend-object, :prerequisites [[:skills/magery 3] :transform-object], :ref "Magic p. 120"}
