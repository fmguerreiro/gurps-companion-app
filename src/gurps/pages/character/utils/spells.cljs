...
(def spells-by-college
  {:fire #{:warmth :resist-fire :seek-fire :flaming-missiles :rain-of-fire :summon-fire-elemental :explosive-fireball :slow-fire :deflect-energy :fire-cloud :phantom-flame :shape-fire :fireproof :ignite-fire :flaming-armor :create-fire-elemental :heat :resist-cold :cold :control-fire-elemental :create-fire :burning-death :smoke :fireball :essential-flame :body-of-flames :flame-jet :flaming-weapon :extinguish-fire :burning-touch :breathe-fire},
   ...
   :body-control #{:hold-breath :total-paralysis :boost-strength :haircut :rooted-feet :itch :stop-spasm :alter-body :transmogrification :enlarge :pain :transform-body :alter-visage :paralyze-limb :hinder :might :boost-dexterity :decapitation :frailty :curse-missile :lengthen-limb :mouth-goes-away :climbing :shrink :alter-voice :spasm :perfume :vigor :clumsiness :mark-of-thieves :strike-barren :transform-other :roundabout :agonize :tickle :reflexes :cadence :resist-pain :balance :shrink-other :ambidexterity :nauseate :corpulence :gauntness :seek-emitter :debility :deathtouch :sensitize :tanglefoot :touch :weaken-blood :choke :sickness :strike-blind :strike-numb :thirst :control-limb :wither-limb :grace :imp-face :boost-health :strike-dumb :strike-deaf :stun :enlarge-other :hunger :hair-growth :fumble :retch},
