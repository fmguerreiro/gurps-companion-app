...
(def spells [{:name :air-jet, :prerequisites [:shape-air], :college :air, :ref "Magic p. 24"}
             ...
             {:name :rebuild, :prerequisites [[:skills/magery 3] :repair :create-object [3 :air] [3 :water] [3 :fire] [3 :earth]], :college :making-and-breaking, :ref "Magic p. 177"}
             ...
             {:name :malfunction, :prerequisites [[:advantages/magery 2] :glitch], :college :technological, :ref "Magic p. 177"}
             ...
             {:name :rebuild, :prerequisites [[:advantages/magery 3] :repair :create-object [3 :air] [3 :water] [3 :fire] [3 :earth]], :college :technological, :ref "Magic p. 177"}
             ...
             ;;{:name :sequence-dna, :prerequisites [[:advantages/magery 2] :divination :analyze-heredity], :college :technological, :ref "Bio-Tech, p. 32"}
             ...
             {:name :acid-ball, :prerequisites [[:advantages/magery 2] :create-acid], :college :water, :ref "Magic p. 191"}
             {:name :acid-jet, :prerequisites [[:advantages/magery 2] :water-jet :create-acid], :college :water, :ref "Magic p. 192"}
             ...
             {:name :body-of-ice, :prerequisites [[:advantages/magery 2] :body-of-water :freeze], :college :water, :ref "Magic p. 189"}
             ...
             {:name :create-water-elemental, :prerequisites [[:advantages/magery 2] :control-water-elemental], :college :water, :ref "Magic p. 22"}
             ...
             {:name :mature, :prerequisites [#{:decay :season}] :college :food :ref "GURPS Magic, p. 78"}
             {:name :cook, :prerequisites [:test-food :create-food] :college :food :ref "GURPS Magic, p. 78"}
             {:name :create-food, :prerequisites [:cook :seek-food] :college :food :ref "GURPS Magic, p. 79; Pyramid 3/60: Dungeon Fantasy III, p. 6"}
             {:name :decay, :prerequisites [:test-food] :college :food :ref "GURPS Magic, p. 77"}
             {:name :far-tasting, :prerequisites [[:advantages/magery 1] #{:seek-food :seek-air}] :college :food :ref "GURPS Magic, p. 77"}
             {:name :essential-food, :prerequisites [:create-food [6 :food]] :college :food :ref "GURPS Magic, p. 79; Pyramid 3/60: Dungeon Fantasy III, p. 6"}
             {:name :fool's-banquet, :prerequisites [[:advantages/magery 1] :cook :foolishness] :college :food :ref "GURPS Magic, p. 79"}
             {:name :foul-water, :prerequisites [:purify-water :decay] :college :food :ref "GURPS Magic, p. 185"}
             {:name :hunger, :prerequisites [[:advantages/magery 1] :debility :decay] :college :food :ref "GURPS Magic, p. 38"}
             {:name :know-recipe, :prerequisites [:far-tasting :season] :college :food :ref "GURPS Magic, p. 78"}
             {:name :poison-food, :prerequisites [:purify-food :decay] :college :food :ref "GURPS Magic, p. 78"}
             {:name :prepare-game, :prerequisites [:purify-food] :college :food :ref "GURPS Magic, p. 78"}
             {:name :preserve-food, :prerequisites [:decay] :college :food :ref "GURPS Magic, p. 79"}
             {:name :purify-food, :prerequisites [:decay] :college :food :ref "GURPS Magic, p. 78"}
             {:name :scents-of-the-past, :prerequisites [[:advantages/magery 2] :history :odor] :college :food :ref "GURPS Magic, p. 107"}
             {:name :season, :prerequisites [:test-food] :college :food :ref "GURPS Magic, p. 77"}
             {:name :seek-food, :prerequisites [] :college :food :ref "GURPS Magic, p. 77"}
             {:name :test-food, :prerequisites [] :college :food :ref "GURPS Magic, p. 77; GURPS Fantasy, p. 169"}
             {:name :thirst, :prerequisites [[:advantages/magery 1] :debility :destroy-water] :college :food :ref "GURPS Magic, p. 38"}
             {:name :water-to-wine, :prerequisites [:purify-water :mature] :college :food :ref "GURPS Magic, p. 79; Pyramid 3/60: Dungeon Fantasy III, p. 6"}
             {:name :wizard-mouth, :prerequisites [:apportation :far-tasting :great-voice] :college :food :ref "GURPS Magic, p. 104"}
             {:name :wizard-nose, :prerequisites [:apportation :far-tasting] :college :food :ref "GURPS Magic, p. 104"}
             {:name :distill, :prerequisites [:mature :destroy-water], :college :water, :ref "GURPS Magic, p. 89"}
